  ...
  const LINES = {
    savage: {
      greet_clean: [
        ...
        '乾淨的清單。希望不是因為你什麼都沒排。',
        '沒有呆帳。你最近是換了一個人嗎？',
        '目前無債一身輕。這狀態能維持幾天，我們打個賭。',
        '帳面漂亮。截圖留念吧，很少見。',
        '今天還沒有把柄。去做點事，別逼我等。',
        '無逾期。我先把罵人的稿子收起來，隨時可以再拿出來。'
      ],
      greet_over: [
        '{n} 筆呆帳掛著。裝死不會讓它消失。',
        '逾期 {n} 件。你的小指記得，你倒是忘了。',
        ...
        '{n} 件過期。你收藏過期的約定是有什麼癖好？',
        '別滑了。{n} 筆帳在等你，它們比限時動態重要。',
        '{n} 件逾期。你上次打開它們的時候，它們還新鮮。',
        '欠 {n} 件。逃避可恥，而且沒有用，分數照扣。',
        '你的清單有 {n} 個活著的證人，都在指控你。',
        '{n} 筆舊帳。今天不清，明天就是 {n} 筆更舊的帳。'
      ],
      greet_todaydue: [
        '今天 {n} 件到期。話是你自己說的。',
        '{n} 個約定今天到期。我看著。',
        '今天的份：{n} 件。太陽下山前搞定。',
        '{n} 件今天到期。別讓它們變成明天的呆帳。',
        '今天 {n} 件。先做最不想做的那件，其他都是甜點。',
        '到期日就是今天。{n} 件。「今天」的意思是今天。',
        '{n} 件今日到期。你排的，不是我排的。',
        '今天要交 {n} 件。做完再來跟我聊天。'
      ],
      add_over: [
        ...
        '額度 {limit}，你塞到 {count}。這不叫上進，叫囤積。−3。',
        '你的信用撐不起這張嘴。第 {count} 件，超貸，−3。',
        '再塞啊。反正躺著的是你的分數，不是我的。−3。',
        '許願免費，超貸要錢。−3 分，慢走不送。'
      ],
      add_debt: [
        ...
        '喜新厭舊。「{title}」在角落哭了 {days} 天。',
        '新約定收到。順帶一提，「{title}」的忌日是 {days} 天前。',
        '你對新事情的熱情，「{title}」{days} 天前也享受過。',
        '記下了。但「{title}」想問你：{days} 天了，還愛我嗎？'
      ],
      resched: [
        ...
        '「{title}」搬家第 {n} 次。它自己都懶得拆行李了。',
        '再延。反正 {due} 到的時候，你還會再延。第 {n} 次，我見證。',
        '你改的不是日期，是你自己的話。第 {n} 次。',
        '{due} 是吧。我先寫進去，鉛筆寫的，反正你會擦。'
      ],
      done_ontime: [
        '說到做到，+{pts}。算你行。',
        '準時。這才叫約定。+{pts}。',
      ...
      done_late: [
        ...
        '拖到最後還是做了。+1。你明明做得到，早點做會死嗎？',
        '遲來的勾。+1。利息已經扣過了，兩清。',
        '好啦，遲到的誠意也是誠意。+1。下不為例——這句我說第幾次了？'
      ],
      backfill: [
        '有做就記，這才像帳。+1。',
        '沒列在單上也做了？行，記上。+1。',
      ...
      notif_evening: [
        ...
        '睡前結帳：{n} 件未清。你知道該怎麼做。',
        '晚安前先對帳：{n} 件。做一件再睡，睡得比較香。',
        '今天的你只剩幾小時，{n} 件事還在排隊。',
        '別急著追劇。{n} 件事的進度條還是 0%。',
        '{n} 件沒勾。今晚的選擇會變成明早的心情。',
        '一天的最後一次提醒：{n} 件。之後就是你和良心的事了。'
      ]
    },
    coach: {
      greet_clean: [
      ...
      greet_over: [
        ...
        '{n} 筆逾期在累積利息，優先清掉。',
        '先清 {n} 件舊帳，今天會順很多。',
        '{n} 件過期了。挑一件十分鐘內能動工的開始。',
        '逾期 {n} 件。與其焦慮，不如先做掉最小的那件。'
      ],
      greet_todaydue: [
        '今天 {n} 件到期，逐一擊破。',
        '{n} 件今日到期，從最難的開始。',
      ...
      add_over: [
        '超過額度了（{limit} 件）。建議先完成或放棄舊項目。−3 分。',
        '第 {count} 件超出負荷，清單短一點反而做得完。−3。',
        '額度滿了。新增前先問自己：哪一件可以放掉？−3。'
      ],
      add_debt: [
        '提醒：「{title}」已擱置 {days} 天，先處理它更好。',
        '新任務收到。「{title}」等了 {days} 天，別忘了它。',
        '加了新的，也記得「{title}」——{days} 天了，拆小一點就能動。'
      ],
      resched: [
        '「{title}」第 {n} 次改期。想一下是不是拆小一點。',
        '延到 {due}。第 {n} 次了，考慮調整範圍。',
        '第 {n} 次改期通常代表估錯量。把它切成兩件試試。'
      ],
      done_ontime: [
        '準時完成，+{pts}。',
        '如期達成，+{pts}。這就是節奏。',
    ...
    soft: {
      ...
      add_over: [
        '手上的約定有點多了（額度 {limit} 件），要不要先收個尾？',
        '記下了。不過 {count} 件有點多，對自己溫柔一點。'
      ],
      add_debt: [
        '「{title}」等你 {days} 天了，別忘了它。',
        '新的記好了。有空也看看「{title}」，它等了 {days} 天。'
      ],
      resched: [
        '「{title}」再延一次沒關係，記得回來。',
        '延到 {due}，到時候一起完成它。'
